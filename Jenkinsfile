pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'vkmohan2007/git-jenkins-docker-k8s-ingress-prometheus-grafana-helm-argocd.git'
        K8S_CLUSTER_NAME = 'microsvc-cluster'
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git 'https://github.com/vkmohan2007/git-jenkins-docker-k8s-ingress-prometheus-grafana-helm-argocd.git'
            }
        }
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                script {
                    withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-cred']]) {
                        sh "sed -i 's|vkmohan2007/git-jenkins-docker-k8s-ingress-prometheus-grafana-helm-argocd.git:latest|vkmohan2007/git-jenkins-docker-k8s-ingress-prometheus-grafana-helm-argocd.git:${env.IMAGE_TAG}|g' k8s/deployment.yaml"
